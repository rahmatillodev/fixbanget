        ...
        <div className="w-full md:w-10/12 lg:w-7/12 flex justify-end h-full">
          <div className="flex flex-col justify-evenly h-full p-4 sm:p-6 gap-4 sm:gap-6">
            ...
            <p className="text-sm sm:text-base">
              Вступайте в наше сообщество в Telegram, чтобы первыми узнавать
              о свежих коллекциях, уникальных предложениях непосредственно из
              Китайской Республики! Исследовать актуальные поступления из
              Страны Дракона Батон преводяшый.
            </p>
            <Link href="/contact">
